...
public final class AccessTokenResult implements ImmutableBean {
  ...
  /**
   * The credentials used to get the current {@link AccessTokenResult}.
   ...
   * @return the instance
   */
  public static AccessTokenResult of(String accessToken, String tokenType, long expiresIn, Credentials credentials) {
    return new AccessTokenResult(accessToken, tokenType, expiresIn, credentials);
  }

  /**
   * Obtains a new instance of {@link AccessTokenResult} with a new set of credentials.
   *
   * @param credentials  the credentials to be used in the newly created AccessTokenResult object
   * @return the instance
   */
  AccessTokenResult withCredentials(Credentials credentials) {
    return new AccessTokenResult(this.accessToken, this.tokenType, this.expiresIn, credentials);
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the credentials used to get the current {@link AccessTokenResult}.
   * This is needed by the re-authentication logic, where the Token Interceptor class has to handle expired or missing tokens.
   * @return the value of the property
   */
  ...
  private static final class Meta extends DirectMetaBean {
     ...
     */
    private final MetaProperty<Credentials> credentials = DirectMetaProperty.ofImmutable(
        this, "credentials", AccessTokenResult.class, Credentials.class);
    /**
     * The meta-properties.
     */
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case -833810928:  // expires_in (alias)
          ...
          break;
        case 288957180:  // credentials
          this.credentials = (Credentials) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
